        ...
        const LANTAI_AI_DEFAULTS = {
            chatEndpoint: 'https://jvpigxbiwmwvxiawcjml.supabase.co/functions/v1/deepseek-chat',
            autoNotesEndpoint: 'https://jvpigxbiwmwvxiawcjml.supabase.co/functions/v1/deepseek-chat',
            model: 'deepseek-chat',
            timeoutMs: 120000
        };
        ...
        async function lantaiAIRequest(endpoint, body, options = {}) {
            ...
            try {
                const sbKey = localStorage.getItem('sbKey') || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imp2cGlneGJpd213dnhpYXdjam1sIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzQ0OTg5MzksImV4cCI6MjA5MDA3NDkzOX0._HuO96XxWQAyyMlVDdwst-1bxYzWW0lT2827SvGn_8w';
